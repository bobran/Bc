...
plot [1.4:4.7][] "< paste data/CoFeSi2.dat data/CoFeSi2e.dat" u 1:($4) smooth bezier t "$\\theta_K$" ls 1,\
"" u 1:(($8-$4*cos(K($1)))/sin(K($1))) smooth bezier t "$\\epsilon_K$" ls 2,\
"data/CoFeSi2.h" u 1:($2) t "$\\theta_K$" w l ls 3 ,\
"" u 1:3 t "$\\epsilon_K$" w l ls 4
