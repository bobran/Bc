...
plot [1.65:4.5][] "< paste data/PLD202.dat data/PLD202e.dat" u 1:4 smooth bezier t "$\\theta_K$" ls 1,\
"" u 1:(-1*($8-$4*cos(K($1)))/sin(K($1))) smooth bezier t "$\\epsilon_K$" ls 2,\
"data/pld202t.dat" u 1:2 t "$\\theta_K$" with lines ls 3,\
"" u 1:(-1*$3) t "$\\epsilon_K$" with lines ls 4
set term epslatex color
set output "PLD202t.tex"
replot
set term wxt
replot
