...
K(x)=(Q(x)*169568.75986+2.884488929)*pi/180.0
plot [1.4:4.6][] "< paste data/CoF-RT-A1100.dat data/CoF-RT-A1100e.dat" u 1:4 smooth bezier t "$\\theta_K$" ls 1,\
"" u 1:(-1*($8-$4*cos(K($1)))/sin(K($1))) smooth bezier t "$\\epsilon_K$" ls 2,\
"data/CoF-RT-A1100m.dat" u 1:2 t "$\\theta_K$" with lines ls 3,\
"" u 1:3 t "$\\epsilon_K$" with lines ls 4
