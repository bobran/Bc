...
Abstract:
Magneto-optical spectroscopy methods are used to research the magnetic properties of materials to nanometer dimensions due to its high sensitivity
and non-contact nature. This requires sophisticated experimental arrangement, intensive technical equipment and set-optical components. This paper 
...
simpler experimental arrangement with crossed polarizers. This arrangement has the same order of sensitivity and accuracy of measurement commonly 
used modulation techniques with which it is compared in this work. Finally, this arrangement is applied to the study of magneto-optical properties 
